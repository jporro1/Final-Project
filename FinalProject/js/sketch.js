...
function draw() {
 ...
 switch(game.state) {
  ...
  case GameState.GameOver:
    ...
    if (recentSquishedBugs > bugLevel)
    {
      recentSquishedBugs = 0;
      bugLevel++;
    }
    break;
...
class WalkingAnimation {
  //add extra sprite sheets for various level increments of bugs
  //spriting is hard :(
